...
<html lang="fr">
	...
	<head>
        <meta charset="utf-8">
        <title> Portfolio | LANGE Paul </title>
	...
	<header> 
		...
		<div class="bloc">
			<div class="textHeader">
				<div class="nameHeader"> <b> LANGE Paul </b> </div>
				Développeur Web 
...
<div class="bloc"> 
	...
	<div class="presentation"> 
		...
		<div class="flex">
			...
			<div class="textPresentationSimple"> Je m'appelle Paul LANGE , j'ai 20 ans , je suis actuellement étudiant en 3ème année à l'école IPSSI à 	Paris. </div> <br> 
		...
		<div class="textPresentationDetail">
			L'informatique est un domaine qui me plait énormément , et ce , depuis mon plus jeune âge. Je veux faire de cette passion mon métier. <br> <br>
​			Mon projet professionnel est de devenir chef de projet en informatique . Pour y arriver , j'aimerais faire une Licence MIAGE après mon BTS , 
			en alternance ou en formation classique. <br> Cette formation me permettrait d'acquérir une double compétence , en informatique et en gestion des entreprises.
...
<center>
		...
		<div id="contact" class="blocContact"> <h2> Contact </h2>
			...
			<br>
			<h3> Adresse : 176 boulevard des Aviateurs Alliés <br> 95610 Eragny sur Oise </h3> 
			<h3> Numéro de téléphone : 06 37 29 49 18 </h3>
			<h3> Email : paul.lange@10gmail.com </h3> <br>
			<h3 id="social-network"> - Réseaux sociaux - </h3> <br> <br>
			<div class="icone"> 
				...
				<a href="https://www.youtube.com/"> <div class="youtube"></div> </a>
